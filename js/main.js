var app = new Vue({
    ...
    featuredProjects: [
      {
        ...
        description: `An online tool to transform raster images into SVG line art. Built using Flask, the OpenCV Python library, Vue and Heroku.`,
      ...
      },
      {
        ...
        description: `Designed/developed the frontend of a curated collection of active publishers, publications, and agencies that pay technical writers.`,
      ...
      },
      {
        ...
        description: `A Mac application that generates short interval workouts to
      ...
      },
      {
        ...
        description: `Web app to calculate an individual's COVID-19 risk
      ...
      },
      {
        ...
        description: `Android app to discover new music through song-based quizzes. Built with Spotify API 
                    and Android Studio.`,
        tags: ['Java', 'API'],
      ...
      },
      {
        ...
        description: `Web application to visualize the locations mentioned in a document. 
      ...
      },
      {
        ...
        description: `Online multiplayer Scrabble game built in collaboration with
      ...
      },
      {
        ...
        description: `Simple web application to generate erasure poetry. Built using the Compromise JS library.`,
        tags: ['JS', 'HTML', 'CSS'],
  ...
  mounted() {
    ...
    window
      ...
      .addListener((e) => e.matches && this.toggleDarkMode())
  },
})
